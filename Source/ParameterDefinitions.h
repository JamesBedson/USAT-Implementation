...

{
    ...
    std::make_unique<juce::AudioParameterChoice>(juce::ParameterID {ProcessingConstants::EncodingOptions::Ambisonics::orderIn, 1},
    ...
    std::make_unique<juce::AudioParameterChoice>(juce::ParameterID {ProcessingConstants::EncodingOptions::Ambisonics::orderOut, 1},
